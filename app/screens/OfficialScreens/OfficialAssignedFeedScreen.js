...
function OfficialAssignedFeedScreen(props) {
  var allCategories = [
    "Road Maintenance",
    "Road Problem",
    "Transportation",
  ...
  useEffect(async () => {
    ...
    const response = await axios
      .get(API_URL + "/officialFeedReportsWithNoSolution", {
        headers: {
  ...
  return (
    ...
    >
      ...
      {!isLoading && feedItems.length == 0 && (
        ...
        >
          No new reports assigned to you.
        </Text>
      )}
...
export default OfficialAssignedFeedScreen;
